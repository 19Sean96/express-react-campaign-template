...
export default (props) => {
    return (
      <div className="WishlistHowTo_guide--step WishlistHowTo_guide--step_1">
        <div className="icon--container">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114.228 90.152">
            <g transform="translate(-485.923 -426.207)">
              <path
