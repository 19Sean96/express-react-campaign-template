...
export default props => {
  return (
    <div className="WishlistHowTo_guide--step WishlistHowTo_guide--step_3">
      <div className="icon--container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160.916 108.093">
          <g transform="translate(-986.122 -421.208)">
            <rect
              width="160.916"
              height="32.484"
      ...
      <p className="WishlistHowTo_guide--step_text">
        add any note<br />or order details
      </p>
    </div>
  );
};
